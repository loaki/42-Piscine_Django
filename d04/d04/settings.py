...
SECRET_KEY = 'django-insecure-w+x8x3vxsy14^rixcmx@x@!imk_qjnk!6yg#e_b!%-e!bjj#!t'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'history_format': {
            '()': 'django.utils.log.ServerFormatter',
            'format': '[{asctime}] h {message}',
            'style': '{',
        },
        'jules_format': {
            '()': 'django.utils.log.ServerFormatter',
            'format': '[{asctime}] jules :{message}',
            'style': '{',
        }
    },
    'handlers': {
    ...
    'loggers': {
        ...
        'jules': {
            'handlers': ['console', 'jules_handler'],
            'level': 'INFO'
        }
    }
}